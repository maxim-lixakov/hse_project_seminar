...
df_temp = pd.read_json(f'/home/mvliksakov/project_seminar/hse_project_seminar/crawling/wildberries/wildberries/spiders/res_for_{date_now}.jl', lines=True)
...
# df_temp['comments'].fillna('0 отзывов')
